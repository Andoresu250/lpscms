...
add_action( 'jupiterx_control_panel_init', function() {
	jupiterx_core()->load_files( [ 'control-panel/class-image-sizes' ] );
} );
...
add_action( 'jupiterx_control_panel_after_theme_settings', function() {
	...
	<div class="form-group col-md-6">
		...
		<?php jupiterx_the_help_link( 'http://help.artbees.net/how-to-s/theme-options/adding-google-analytics-code-into-jupiter-x', __( 'Adding Google Analytics code into Jupiter X', 'jupiterx-core' ) ); ?>
	...
	<div class="form-group col-md-12">
		...
		<?php jupiterx_the_help_link( 'http://help.artbees.net/how-to-s/typography/using-adobe-fonts-formerly-typekit-in-jupiter-x', __( 'Using Adobe fonts (formerly Typekit) in Jupiter X', 'jupiterx-core' ) ); ?>
	...
	<div class="form-group col-md-6">
		...
		<textarea <?php echo esc_attr( ( ! jupiterx_is_pro() ) ? 'disabled' : '' ); ?> class="jupiterx-form-control" rows="7" id="jupiterx-cp-settings-tracking-codes-after-head" name="jupiterx_tracking_codes_after_head" rows="3"><?php echo esc_html( get_option( 'jupiterx_tracking_codes_after_head' ) ); ?></textarea>
	</div>
	<div class="form-group col-md-6">
		...
		<textarea <?php echo esc_attr( ( ! jupiterx_is_pro() ) ? 'disabled' : '' ); ?> class="jupiterx-form-control" rows="7" id="jupiterx-cp-settings-tracking-codes-before-head" name="jupiterx_tracking_codes_before_head" rows="3"><?php echo esc_html( get_option( 'jupiterx_tracking_codes_before_head' ) ); ?></textarea>
	</div>
	<div class="form-group col-md-6">
		...
		<textarea <?php echo esc_attr( ( ! jupiterx_is_pro() ) ? 'disabled' : '' ); ?> class="jupiterx-form-control" rows="7" id="jupiterx-cp-settings-tracking-codes-after-body" name="jupiterx_tracking_codes_after_body" rows="3"><?php echo esc_html( get_option( 'jupiterx_tracking_codes_after_body' ) ); ?></textarea>
	</div>
	<div class="form-group col-md-6">
		...
		<textarea <?php echo esc_attr( ( ! jupiterx_is_pro() ) ? 'disabled' : '' ); ?> class="jupiterx-form-control" rows="7" id="jupiterx-cp-settings-tracking-codes-before-body" name="jupiterx_tracking_codes_before_body" rows="3"><?php echo esc_html( get_option( 'jupiterx_tracking_codes_before_body' ) ); ?></textarea>
	</div>
	<?php
} );
