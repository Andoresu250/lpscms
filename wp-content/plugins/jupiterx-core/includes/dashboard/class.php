...
class JupiterX_Dashboard {
	...
	public function ajax_handler() {
		...
		if ( ! $type ) {
			wp_send_json_error( __( 'Type param is missing.', 'jupiterx-core' ) );
		}
	...
	public function get_sites() {
		try {
			...
			if ( ! function_exists( 'get_sites' ) ) {
				throw new Exception( __( 'The get_sites function is not defined.', 'jupiterx-core' ) );
			}
	...
	public function flush_network_cache() {
		try {
			...
			if ( ! $sites ) {
				throw new Exception( __( 'Site param is missing.', 'jupiterx-core' ) );
			}
