...
class JupiterX_Overview_Widget {
	...
	public function register() {
		...
		add_meta_box( 'jupiterx-dashboard-overview', __( 'Jupiter X Overview', 'jupiterx-core' ), [ $this, 'render_content' ], 'dashboard', 'side', 'high' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style(
			...
			JUPITERX_ASSETS_URL . 'dist/css/admin/dashboard-widgets' . JUPITERX_MIN_CSS . '.css',
			[],
			JUPITERX_VERSION
		);
		...
		wp_enqueue_script(
			'jupiterx-admin-dashboard',
			JUPITERX_ASSETS_URL . 'dist/js/admin/dashboard-widgets' . JUPITERX_MIN_JS . '.js',
			[ 'jquery' ],
			JUPITERX_VERSION,
			true
		);
