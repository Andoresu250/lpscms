...
class JupiterX_Widget extends WP_Widget {
	...
	public function scripts() {
		wp_enqueue_script( 'jupiterx-widget-controls', JUPITERX_ASSETS_URL . 'dist/js/admin/widget-controls' . JUPITERX_MIN_JS . '.js', [ 'jquery', 'wp-color-picker' ], JUPITERX_VERSION, false );

		wp_enqueue_script( 'jupiterx-jquery-conditioner', JUPITERX_ASSETS_URL . 'js/lib/jquery.conditioner.js', [ 'jquery' ], JUPITERX_VERSION, false );
	...
	public function styles() {
		wp_enqueue_style( 'jupiterx-widget-controls', JUPITERX_ASSETS_URL . 'dist/css/admin/widget-controls' . JUPITERX_MIN_CSS . '.css', [ 'wp-color-picker' ], JUPITERX_VERSION );
