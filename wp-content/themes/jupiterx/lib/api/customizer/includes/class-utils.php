...
final class JupiterX_Customizer_Utils {
	...
	public static function get_assets_url() {
		return JUPITERX_CUSTOMIZER_URL . 'assets';
	}
	...
	public static function get_icon_url( $file_name ) {
		return ( ! empty( $file_name ) ) ? JUPITERX_CUSTOMIZER_URL . 'assets/img/' . $file_name . '.svg' : '';
	}
	...
	public static function print_svg_icon( $file_name ) {
		...
		$file_path = JUPITERX_CUSTOMIZER_PATH . 'assets/img/' . $file_name . '.svg';
	...
	public static function get_preview_url( $section = 'home' ) {
		switch ( $section ) {
			...
			// Archive pages.
			case 'blog_archive':
				return get_term_link( self::get_random_term( 'category' ) );

			case 'product_archive':
				return get_term_link( self::get_random_term( 'product_cat' ) );
