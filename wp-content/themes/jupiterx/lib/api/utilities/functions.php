 ...
 *
 * A wrapper around WordPress native function.
 *
 * @since 1.2.0
 *
 * @param string $plugin The plugin name.
 */
function jupiterx_is_plugin_active( $plugin = '' ) {

	// Get correct plugin path.
	switch ( $plugin ) {
		case 'core':
			$plugin = 'JupiterX_Core';
			break;
