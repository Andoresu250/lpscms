...
add_action( 'admin_enqueue_scripts', 'jupiterx_elementor_register_scripts' );
/**
...
function jupiterx_elementor_register_scripts() {
	...
	wp_enqueue_script( 'jupiterx-elementor', JUPITERX_API_URL . 'elementor/assets/js/elementor' . JUPITERX_MIN_JS . '.js', [ 'jupiterx-featherlight' ], JUPITERX_VERSION, true );
	...
	wp_enqueue_style( 'jupiterx-elementor', JUPITERX_API_URL . 'elementor/assets/css/elementor' . JUPITERX_MIN_CSS . '.css', [ 'jupiterx-featherlight' ], JUPITERX_VERSION );
}
...
function jupiterx_elementor_editor_enqueue_scripts() {
	...
	if ( 'jupiterx-customizer' === jupiterx_get( 'context' ) ) {
		wp_enqueue_style(
			...
			JUPITERX_API_URL . 'elementor/assets/css/editor-embedded' . JUPITERX_MIN_CSS . '.css',
			[],
			JUPITERX_VERSION
		);
	}
	...
	wp_enqueue_style(
		...
		JUPITERX_API_URL . 'elementor/assets/css/editor' . JUPITERX_MIN_CSS . '.css',
		[],
		JUPITERX_VERSION
	);
	...
	wp_enqueue_script(
		'jupiterx-elementor-editor',
		JUPITERX_API_URL . 'elementor/assets/js/editor' . JUPITERX_MIN_JS . '.js',
		[ 'jquery' ],
		JUPITERX_VERSION,
		true
	);
	...
	wp_enqueue_style(
		...
		JUPITERX_ADMIN_URL . 'assets/css/icons-admin.css',
		[],
		JUPITERX_VERSION
	);
	...
	wp_enqueue_style(
		'jupiterx-modal',
		JUPITERX_CONTROL_PANEL_ASSETS_URL . 'css/jupiterx-modal' . JUPITERX_MIN_CSS . '.css',
		[],
		JUPITERX_VERSION
	);
	...
	wp_enqueue_script(
		'jupiterx-modal',
		JUPITERX_CONTROL_PANEL_ASSETS_URL . 'js/jupiterx-modal' . JUPITERX_MIN_JS . '.js',
		[],
		JUPITERX_VERSION,
		true
	);
	...
	wp_enqueue_style(
		'jupiterx-common',
		JUPITERX_ADMIN_ASSETS_URL . 'css/common' . JUPITERX_MIN_CSS . '.css',
		[],
		JUPITERX_VERSION
	);
	...
	wp_enqueue_script(
		'jupiterx-common',
		JUPITERX_ADMIN_ASSETS_URL . 'js/common' . JUPITERX_MIN_JS . '.js',
		[ 'wp-util' ],
		JUPITERX_VERSION,
		true
	);
...
function jupiterx_elementor_flush_cache() {
	if ( ! jupiterx_is_plugin_active( 'elementor' ) ) {
		return false;
	}
