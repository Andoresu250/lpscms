...
<div class="jupiterx-cp-pane-box" id="jupiterx-cp-system-status">
	<h3>
		...
		<?php jupiterx_the_help_link( 'http://help.artbees.net/getting-started/installing-the-theme/checking-server-requirements', __( 'Checking Server Requirements', 'jupiterx' ) ); ?>
	</h3>
	...
	<table class="table" cellspacing="0">
		...
		<tr>
			...
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'The URL of WordPress\'s content directory.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
		...
		<tr>
			<td data-export-label="WP Upload Path">
				<?php esc_html_e( 'WP Upload Path', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'The absolute path to WordPress\'s upload directory.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
		...
		<tr>
			<td data-export-label="WP Upload URL">
				<?php esc_html_e( 'WP Upload URL', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'The URL of WordPress\'s upload directory.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
...
?>
		...
		<tr>
			<td data-export-label="The Main WP Directory">
				<?php esc_html_e( 'The Main WP Directory', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Check if main WP directory is writable.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				<?php if ( wp_is_writable( $sysinfo['wp_writable'] ) ) : ?>
					<span class="status-invisible">True</span><span class="status-state status-true"></span>
					<span><?php esc_html_e( 'Writable', 'jupiterx' ); ?></span>
				<?php else : ?>
					<span class="status-invisible">False</span><span class="status-state status-false"></span>
					<span><?php printf( __( 'Make sure <code>%s</code> directory is writable.', 'jupiterx' ), $sysinfo['wp_writable'] ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		<tr>
			<td data-export-label="The wp-content Directory">
				<?php esc_html_e( 'The wp-content Directory', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Check if wp-content directory is writable.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				...
				<?php else : ?>
					<span class="status-invisible">False</span><span class="status-state status-false"></span>
					<span><?php printf( __( 'Make sure <code>%s</code> directory is writable.', 'jupiterx' ), $sysinfo['wp_content_writable'] ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		<tr>
			<td data-export-label="The uploads Directory">
				<?php esc_html_e( 'The uploads Directory', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Check if uploads directory is writable.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				...
				<?php else : ?>
					<span class="status-invisible">False</span><span class="status-state status-false"></span>
					<span><?php printf( __( 'Make sure <code>%s</code> directory is writable.', 'jupiterx' ), $sysinfo['wp_uploads_writable'] ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		<tr>
			<td data-export-label="The plugins Directory">
				<?php esc_html_e( 'The plugins Directory', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Check if plugins directory is writable.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				...
				<?php else : ?>
					<span class="status-invisible">False</span><span class="status-state status-false"></span>
					<span><?php printf( __( 'Make sure <code>%s</code> directory is writable.', 'jupiterx' ), $sysinfo['wp_plugins_writable'] ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		<tr>
			<td data-export-label="The themes Directory">
				<?php esc_html_e( 'The themes Directory', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Check if themes directory is writable.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				...
				<?php else : ?>
					<span class="status-invisible">False</span><span class="status-state status-false"></span>
					<span><?php printf( __( 'Make sure <code>%s</code> directory is writable.', 'jupiterx' ), $sysinfo['wp_themes_writable'] ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		</tbody>
	...
	<table class="table" cellspacing="0">
		...
		// Iconv.
		$posting['iconv']['name'] = esc_html__( 'Iconv', 'jupiterx' );
		$posting['iconv']['help'] = esc_attr__( 'Used in CSS parser to handle the character set conversion.', 'jupiterx' );

		if ( extension_loaded( 'iconv' ) ) {
			$posting['iconv']['success'] = true;
		} else {
			$posting['iconv']['note']    = esc_html__( 'Iconv library is missing. Install the iconv extension. Contact your hosting provider.', 'jupiterx' );
		...
		?>
			<tr data-jupiterx-ajax="http_requests">
				<td data-export-label="HTTP Requests">
					<?php esc_html_e( 'HTTP Requests', 'jupiterx' ); ?>:
				</td>
				<td class="help">
					<a class="jupiterx-tooltip" data-content="<?php esc_attr_e( 'Check if HTTP requests (get, post and ...) are working properly.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
				</td>
				<td>
			...
			<tr data-jupiterx-ajax="artbees_server">
				<td data-export-label="Communication with artbees.net">
					<?php esc_html_e( 'Communication with artbees.net', 'jupiterx' ); ?>:
				</td>
				<td class="help">
					<a class="jupiterx-tooltip" data-content="<?php esc_attr_e( 'Check if you have proper access to artbees.net server.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
				</td>
				<td>
					<span class="status-state"><span class="spinner is-active"></span></span>
					<span class="status-text"></span>
