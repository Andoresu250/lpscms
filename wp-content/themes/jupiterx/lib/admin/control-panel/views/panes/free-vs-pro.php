...
<div class="jupiterx-cp-pane-box" id="jupiterx-cp-comparison">
	<table class="jupiterx-comparison-table">
		...
		<tr>
			...
			<td><?php esc_html_e( '170+ templates', 'jupiterx' ); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="jupiterx-ct-text-center jupiterx-ct-bg-normal">
				<button class="btn btn-large jupiterx-btn-upgrade-pro jupiterx-upgrade-modal-trigger" data-upgrade-link="<?php echo esc_attr( jupiterx_upgrade_link( 'comparison' ) ); ?>"><?php esc_html_e( 'Upgrade now', 'jupiterx' ); ?></button>
