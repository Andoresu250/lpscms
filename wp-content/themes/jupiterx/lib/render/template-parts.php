...
function jupiterx_elementor_template_types() {
	...
	if ( 'elementor_library' !== get_post_type() || ! in_array( $template_type, [ 'section', 'header', 'footer' ], true ) ) {
		return;
	}
...
add_action( 'template_redirect', 'jupiterx_customizer_preview_redirect' );
/**
 ...
 */
function jupiterx_customizer_preview_redirect() {
